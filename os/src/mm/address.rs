...
use crate::config::{PAGE_BITS_SIZE, PAGE_SIZE};
...
// 物理页号位宽
const PPN_WIDTH_SV39: usize = PA_WIDTH_SV39 - PAGE_BITS_SIZE;
...
// 虚拟页号位宽
const VPN_WIDTH_SV39: usize = VA_WIDTH_SV39 - PAGE_BITS_SIZE;
